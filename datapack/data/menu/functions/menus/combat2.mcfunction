...
execute if entity @s[scores={CollectionDelay=0},nbt=!{Items:[{Slot: 10b, id: "minecraft:slime_ball"}]}] at @a[scores={C_SlimeballS=1..},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function menu:click/combat/slimeball
execute if entity @s[scores={CollectionDelay=0},nbt=!{Items:[{Slot: 11b, id: "minecraft:blaze_rod"}]}] at @a[scores={C_BlazerodS=1..},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function menu:click/combat/blazerod
execute if entity @s[scores={CollectionDelay=0},nbt=!{Items:[{Slot: 12b, id: "minecraft:magma_cream"}]}] at @a[scores={C_MagmacreamS=1..},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function menu:click/combat/magmacream

execute if entity @s[scores={CollectionDelay=0},nbt=!{Items:[{Slot: 9b, id: "minecraft:arrow"}]}] run scoreboard players set @s CollectionPage 3
...
execute at @s as @a[nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.10 loot collections:combat/combat2
#------------------------------------------#