...
execute if entity @s[scores={CollectionDelay=0},nbt=!{Items:[{Slot: 10b, id: "minecraft:redstone"}]}] at @a[scores={C_RedstoneS=1..},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function menu:click/mining/redstone
execute if entity @s[scores={CollectionDelay=0},nbt=!{Items:[{Slot: 11b, id: "minecraft:quartz"}]}] at @a[scores={C_QuartzS=1..},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function menu:click/mining/quartz
execute if entity @s[scores={CollectionDelay=0},nbt=!{Items:[{Slot: 12b, id: "minecraft:obsidian"}]}] at @a[scores={C_ObsidianS=1..},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function menu:click/mining/obsidian
execute if entity @s[scores={CollectionDelay=0},nbt=!{Items:[{Slot: 13b, id: "minecraft:glowstone_dust"}]}] at @a[scores={C_GlowstoneS=1..},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function menu:click/mining/glowstone
execute if entity @s[scores={CollectionDelay=0},nbt=!{Items:[{Slot: 14b, id: "minecraft:gravel"}]}] at @a[scores={C_GravelS=1..},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function menu:click/mining/gravel
execute if entity @s[scores={CollectionDelay=0},nbt=!{Items:[{Slot: 15b, id: "minecraft:ice"}]}] at @a[scores={C_IceS=1..},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function menu:click/mining/ice
execute if entity @s[scores={CollectionDelay=0},nbt=!{Items:[{Slot: 16b, id: "minecraft:netherrack"}]}] at @a[scores={C_NetherrackS=1..},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function menu:click/mining/netherrack

execute if entity @s[scores={CollectionDelay=0},nbt=!{Items:[{Slot: 9b, id: "minecraft:arrow"}]}] run scoreboard players set @s CollectionPage 2
execute if entity @s[scores={CollectionDelay=0},nbt=!{Items:[{Slot: 9b, id: "minecraft:arrow"}]}] run function menu:clickevent

execute if entity @s[scores={CollectionDelay=0},nbt=!{Items:[{Slot: 17b, id: "minecraft:arrow"}]}] run scoreboard players set @s CollectionPage 9
...
execute at @s as @a[nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.4 loot collections:miningsub
execute at @s as @a[nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.10 loot collections:mining/mining2
#------------------------------------------#