...
execute if entity @s[scores={CollectionDelay=0},nbt=!{Items:[{Slot: 10b, id: "minecraft:cod"}]}] at @a[scores={C_CodS=1..},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function menu:click/fishing/cod
execute if entity @s[scores={CollectionDelay=0},nbt=!{Items:[{Slot: 11b, id: "minecraft:salmon"}]}] at @a[scores={C_SalmonS=1..},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function menu:click/fishing/salmon
execute if entity @s[scores={CollectionDelay=0},nbt=!{Items:[{Slot: 12b, id: "minecraft:tropical_fish"}]}] at @a[scores={C_TropicalfishS=1..},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function menu:click/fishing/tropicalfish
execute if entity @s[scores={CollectionDelay=0},nbt=!{Items:[{Slot: 13b, id: "minecraft:pufferfish"}]}] at @a[scores={C_PufferfishS=1..},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function menu:click/fishing/pufferfish
execute if entity @s[scores={CollectionDelay=0},nbt=!{Items:[{Slot: 14b, id: "minecraft:prismarine_shard"}]}] at @a[scores={C_PshardS=1..},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function menu:click/fishing/pshard
execute if entity @s[scores={CollectionDelay=0},nbt=!{Items:[{Slot: 15b, id: "minecraft:prismarine_crystals"}]}] at @a[scores={C_PcrystalS=1..},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function menu:click/fishing/pcrystal
execute if entity @s[scores={CollectionDelay=0},nbt=!{Items:[{Slot: 16b, id: "minecraft:clay_ball"}]}] at @a[scores={C_ClayS=1..},nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @p PlayerID run function menu:click/fishing/clay

execute if entity @s[scores={CollectionDelay=0},nbt=!{Items:[{Slot: 17b, id: "minecraft:arrow"}]}] run scoreboard players set @s CollectionPage 11
...
execute at @s as @a[nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.4 loot collections:fishingsub
execute at @s as @a[nbt={SelectedItemSlot:8},tag=Menu,distance=..4] if score @s PlayerID = @e[tag=MenuChest,sort=nearest,limit=1] PlayerID run loot replace entity @e[tag=MenuChest,sort=nearest,limit=1] container.10 loot collections:fishing/fishing
#------------------------------------------#